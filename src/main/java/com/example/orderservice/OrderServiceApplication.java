...
class Runner implements ApplicationRunner {
	...
	public void run(ApplicationArguments args) throws Exception {
		...
		StateMachine<OrderStates, OrderEvents> fulfillmentStateMachine = orderService.fulfill(order.getId());
		log.info("after calling fulfill() " + fulfillmentStateMachine.getState().getId().name());
		log.info("order " + orderService.byId(order.getId()));
